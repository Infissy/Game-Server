...
describe("Get Deck", () => {
  it("DeckInitialization", (done) => {
    ...
    wsClient.on("message", (deckRequest) => {
      ...
      let message: Message = JSON.parse(deckRequest.toString());
